...
public class SplBean {
    String orderid ,ename ,mobile ,Dress ,dod ;
    int qty ,bill  ;
    String mesurements ,worker;
    int stat;

    public SplBean(String orderid, String ename, String mobile, String dress, String dod, int qty, int bill, String mesurements, String worker, int stat) {
